  ...
  const achievements = [
    {
      ...
      highlights: [
        ...
        "Designed for scale and simplicity—onboarded 200+ creators within the first release phase."
      ]
    },
    {
      icon: "🧠",
    ...
    },
    {
      ...
      highlights: [
        ...
        "Launched on schedule despite shifting requirements—achieved 99.9% uptime during first production rollout."
      ]
    }
  ];
</script>
